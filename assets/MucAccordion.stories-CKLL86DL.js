...
`}}}},c=()=>({components:{MucAccordion:i,MucAccordionItem:o},template:`
    ...
    `}),f=[`Template`,`Multiple`,`DetailPageMargin`,`WithMetadataHeader`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => ({
  components: {
    MucAccordion,
    MucAccordionItem
  },
  ...
  template: \`
    ...
    \`
})`,...d.parameters?.docs?.source}}}})))()}p();export{u as DetailPageMargin,l as Multiple,c as Template,d as WithMetadataHeader,f as __namedExportsOrder,s as default};