import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{M as t,N as n,P as r,c as i,s as a}from"./blocks-EhZhd50b.js";function o(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...n(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(a,{title:`Getting Started`}),`
...
`})}),`
`,(0,c.jsx)(t.h3,{id:`font-setup-required-for-local-development`,children:`Font setup (required for local development)`}),`
`,(0,c.jsxs)(t.p,{children:[`When using the library with web components, ensure the MDE fontfaces are loaded in your application's `,(0,c.jsx)(t.code,{children:`index.html`}),`:`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-html`,children:`<link
  href="https://assets.muenchen.de/mde/1.1.27/css/fonts.css"
  rel="stylesheet"
/>
`})}),`
