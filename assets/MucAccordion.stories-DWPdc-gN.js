import{_ as m}from"./MucIcon-z9ASVbhx.js";import{M as e}from"./MucAccordion-cXFyK_Da.js";import{_ as i}from"./MucAccordionItem-CvSZO9q_.js";import"./iframe-CeNjih2_.js";import"./preload-helper-PPVm8Dsz.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const u={components:{MucAccordion:e},component:e,title:"Accordion/MucAccordion",tags:["autodocs"],parameters:{docs:{description:{component:`The \`muc-accordion\` component offers the option of displaying content clearly in an accordion format. <br> A template with the following v-slot must be placed around the MucAccordionItems \`v-slot:default=“{onOpen, onClose, activeItems}”\`. <br> Each MucAccordionItem must be passed the following parameters with exactly these values: \`:active-items="activeItems"\` \`@open="onOpen"\` \`@close="onClose"\` . <br> For example:
