import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,n,r,t as i}from"./MucRadioButtonGroup-BtVhQxqk.js";var a,o,s;function c(){return(c=e((()=>{t(),n(),a={component:r,title:`Forms/MucRadioButton`,tags:[`autodocs`],parameters:{docs:{description:{component:`
...
`}}}},o=()=>({components:{MucRadioButton:r,MucRadioButtonGroup:i},template:`
  ...
  `}),s=[`Default`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => ({
  components: {
    MucRadioButton,
    MucRadioButtonGroup
  },
