import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{V as t,n}from"./iframe-fF_oSg7y.js";import{t as r}from"./MucButton-CqXfywJe.js";import{t as i}from"./Button-B7X3vKmU.js";import{n as a,t as o}from"./MucModal-BZycSY5M.js";var s,c,l,u,d,f;function p(){return(p=e((()=>{n(),i(),a(),s={component:o,title:`MucModal`,tags:[`autodocs`],parameters:{docs:{description:{component:`The \`muc-modal\` component can be used to display a modal dialog which overlay the user interface.
...
`}}}},c=e=>({components:{MucModal:o,MucButton:r},setup(){return{args:e,openState:t(e.open),closeDialog:()=>e.open=!1}},template:`
  ...
  `}),d=u.bind({args:{open:!1}}),f=[`Default`,`Minimal`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`defaultTemplate.bind({
  args: {
    open: false
  }
...
})`,...d.parameters?.docs?.source}}}})))()}p();export{l as Default,d as Minimal,f as __namedExportsOrder,s as default};